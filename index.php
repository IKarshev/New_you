                ...
                <div class="item_container">
                    ...
                    <div class="item left">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="title">Моделирующий массаж лица</div>
                                <div class="price">600р</div>
                            </li>
                            <li>
                                <div class="title">Лимфодренажный</div>
                                <div class="price">1200р</div>
                            </li>
                            <li>
                                <div class="title">Массаж головы</div>
                                <div class="price">600р</div>
                            </li>
                            <li>
                                <div class="title">Детский массаж (от 0 до 7 лет)</div>
                                <div class="price">600р</div>
                            </li>
                            <li>
                                <div class="title">Детский массаж (от 7 до 14)</div>
                                <div class="price">700р</div>
                            </li>
                        </ul>
                    </div>
